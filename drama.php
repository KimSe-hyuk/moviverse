...
?>
        		    <div class="movie_all">
                <p class="movietext"> 드라마/시리즈ㅣ <?=$row['genres_name']?> </p>
<?php
}
?>
                <script>
...
<img onclick="location.href='drama.php?bid='" class="where_logo"src="img/all.png">
                ...
                <div style="display: none;" id="myDIV">
                    ...
                    <p id="pop"><a style="color: <?php 	if($Popularity_Newest=="popularity"){echo'#3482EA';}else{echo'#BDBDBD';}?>;"href="drama.php?Popularity_Newest=popularity&bid=<?=$bid?>&search=<?=$search?>&platform=<?=$platform?>">인기순</a></p>

                    <p id="now"><a style="color:  <?php if($Popularity_Newest!="popularity"){echo '#3482EA';}else{echo'#BDBDBD';}?>;" href="drama.php?Popularity_Newest=release_date&bid=<?=$bid?>&search=<?=$search?>&platform=<?=$platform?>">최신순</a></p>
