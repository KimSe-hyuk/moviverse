      ...
      <input id="searchInput"  type="text"  placeholder="드라마/시리즈, 영화 제목 검색해주세요" name="search" size="35" required="required" /> 
        ...
        <form method="post" action="member_join_in.php" name="memform">
            <div class="memberjoin_tle">
                ...
                <input style="margin-top: 234px;" class="member_join_pw" type="password" id="pw1"name="pw" placeholder="비밀번호 입력">
                <input style="margin-top: 322px;" class="member_join_pw" type="password" id="pw2"name="pw" placeholder="비밀번호 확인">
               <p class="pwrepl"id="pw_check"style="">비밀번호 중복확인</p>
			   <input style="margin-top: 422px;width: 263px;" class="member_join_text" id="lo2" type="text" name="name" placeholder="닉네임">
