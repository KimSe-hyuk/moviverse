...
?>
  ...
  <ul class="ul-text">
                ...
                <li style="font-size:16px;margin-bottom:5px;    width: 1100px; line-height: normal;"><b>배우 </b>: <?=$row['cast'];?></li>
	...
	?>
        ...
        <div style="margin-bottom:30px;" class="sinup"><b>다른 이용자 평</b>
			...
			if($pougodd=="good"){
						...
						?>;" id="pop"onclick="location.href='choice.php?choice=<?=$choice?>&id=<?=$id?>&pougodd=good#pop';">인기순 </div>
            <div style="color: <?php 
					if($pougodd=="review_date"){
						echo'#3482EA';
						}else{echo'#BDBDBD';}?>; " id="new"onclick="location.href='choice.php?choice=<?=$choice?>&id=<?=$id?>&pougodd=review_date#new';">최신순</div>
        </div>
