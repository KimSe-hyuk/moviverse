...
<?php 
	...
	$bookmark =$db->query("select count(*) from  bookmark  where member_num='$_SESSION[userNum]' ")->fetchColumn();
	$writetext=$db->query("select count(*) from  review  where member_num='$_SESSION[userNum]'  ")->fetchColumn();
...
<div class="main">
   ...
   <div class="main_Img">
	 ...
	 <p class="name"style="width:auto"><?=$row['nickname']?></p>
...
$(document).ready(function(){
  var fileTarget = $('.filebox .upload-hidden');
    ...
    fileTarget.on('change', function(){
	 ...
	 <div style="margin-left:100px;"class="filebox">
    <label for="file"></label> 
	    <input type="file"  name="imgFile" id="file"class="upload-hidden">
    <input class="upload-name" value="" placeholder="첨부파일" >
	</div> 

   <button style="margin-left:100px;" class="submit" type="submit">저장</button>
	 </form>
     <p class="id_main"><?=$row['email']?></p>
	<p style="margin-top:50px;width:auto;"class="id_main">ㆍ북마크 <?=$bookmark?>개 ㆍ내가 쓴 글<?=$writetext?>개 </p>
 </div>   
 <div class="text_div">
  <h1>비밀번호 수정   <img  onclick="location.href='pwre.php';" style="float:right;    cursor: pointer;" src="img/arrow1.png"></h1>
<p style="font-weight: 700;">-비밀번호를 수정하여 내정보를 보호하세요.   </p><br>
<h1>내 북마크 <img onclick="location.href='mybook.php';" style="float:right;    cursor: pointer;" src="img/arrow1.png"></h1>
<p  style="font-weight: 700;">-북마크 기능을 통해 나만의 작품을 관리하세요. </p><br>
<h1>작성한 평가 <img onclick="location.href='myreview.php';" style="float:right;    cursor: pointer;" src="img/arrow1.png"></h1>
