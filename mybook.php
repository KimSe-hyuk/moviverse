...
<div style="margin:24px 0 0 24px;widht:700px;" class="movie_bookmark">
            <img onclick="location.href='choice.php?choice=<?= $row['choice']?>&id=<?=$row['id']?>'" style="    cursor: pointer;"  class="movie" src="https://image.tmdb.org/t/p/w220_and_h330_face<?=$row['poster_path'];?>">
...
?>
        <div style="top:1330px"class="page_num">
            <?php
		if($firstLink>1){
?>
