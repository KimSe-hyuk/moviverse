...
<div class="all">
 <div class="head">
	...
	<a href="/html/index.php"><img class="logo"src="/html/img/logo.png"></a>			<!-- 링크걸기 -->
</div>


<div class="sidenav">
  <a href="/html/phptest/list.php">관리자 페이지</p>
  <a href="/html/phptest/user/list.php">회원 정보</a>
  <br><br>
  <a href="/html/phptest/movie/list.php">영화 정보</a>
  <br><br>
  <a href="/html/phptest/tv/list.php">TV 정보</a>
